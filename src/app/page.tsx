    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg bg-slate-900/60 backdrop-blur-xl rounded-3xl p-8 border border-slate-800 shadow-2xl relative z-10 my-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent">
            イベント参加受付登録
          </h1>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] text-slate-400/80 px-2 leading-tight">
                    ※Android端末では、カメラアプリによってDiscordのQRコードが読み込めない場合があります。
                  </p>
                </div>
      ...
      <div className="absolute bottom-4 right-4 z-50">
        <a href="/admin/queue" className="text-slate-700 hover:text-slate-400 transition" title="Admin Dashboard">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
